...
export default function CustomersPage() {
  ...
  const avgVisits = customers.length ? (customers.reduce((s, c) => s + (c.visit_count ?? c.total_visits), 0) / customers.length).toFixed(1) : '0'
  ...
  return (
    <div>
      ...
      <div className="stats">
        ...
        <div className="scard"><div className="sv">{avgVisits}×</div><div className="sl">Avg. Visits</div></div>
              ...
              {filtered.map(c => {
                ...
                return (
                  <tr key={c.id}>
                    ...
                    <td><span className="vcnt">{visits}×</span></td>
      ...
      <style jsx>{`
        ...
        .btn-exp { padding:10px 16px; background:white; color:#2C1810; border:1.5px solid rgba(0,0,0,0.12); border-radius:10px; font-size:13px; font-weight:700; cursor:pointer; white-space:nowrap; }
        ...
        .search:focus { border-color:#C8873A; }
